...
#' @importFrom ggplot2 ggplot geom_point scale_color_manual guide_legend labs
#' theme element_blank coord_fixed aes_string
#
...
BlendPlot <- function(
  ...
  p <- ggplot(data = data.plot, mapping = aes_string(x = 'x', y = 'y'))
  p <- p + geom_point(
